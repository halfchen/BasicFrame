package com.chen.base.dialog.dialog;
...
import com.chen.base.widget.AmountView;
...
public class AnyLayer implements LayerManager.LiveListener {
    ...
    public AnyLayer setVisibility(@IdRes int viewId, int visibility) {
        mContent.findViewById(viewId).setVisibility(visibility);
        return this;
    }

    public AnyLayer setText(@IdRes int viewId, String value) {
        TextView textView = mContent.findViewById(viewId);
    ...
    public AnyLayer setGoodsStorage(@IdRes int viewId, int num) {
        AmountView view = mContent.findViewById(viewId);
        view.setGoods_storage(num);
        return this;
    }

    public AnyLayer setLinearAdapter(@IdRes int viewId, CommonRecyclerAdapter adapter) {
        RecyclerView recyclerView = mContent.findViewById(viewId);
        recyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        recyclerView.setAdapter(adapter);
        return this;
    }

    public AnyLayer setGridAdapter(@IdRes int viewId, CommonRecyclerAdapter adapter, int index) {
        RecyclerView recyclerView = mContent.findViewById(viewId);
        recyclerView.setLayoutManager(new GridLayoutManager(mContext, index));
        recyclerView.setAdapter(adapter);
        return this;
    }

    public AnyLayer setGridAdapter(@IdRes int viewId, CommonRecyclerAdapter adapter, GridLayoutManager layoutManager) {
        RecyclerView recyclerView = mContent.findViewById(viewId);
