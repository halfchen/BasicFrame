 ...
 * 2019-9-19
 **/
@Route(path = RouterFragmentPath.Video.PAGER_WEEKLY)
public class WeeklyFragment extends BaseFragment<FragmentRankBinding, RankFragmentViewModel> {
    ...
    private void requestWeekly() {
        viewModel.requestWeekly(start,num).observe(this, new Observer<AllRec>() {
            @Override
