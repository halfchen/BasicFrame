...
public class SearchViewModel extends BaseViewModel {
    ...
    public MutableLiveData<AllRec> requestSearch(int start, int num, String query) {
        final MutableLiveData<AllRec> data = new MutableLiveData<>();
        Disposable disposable = HttpClient.Builder.getEyeService().getSearch(start, num, query)
