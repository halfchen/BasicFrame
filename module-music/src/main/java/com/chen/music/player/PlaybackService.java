...
import com.chen.music.debug.DebugActivity;
...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "com.chen.music.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.chen.music.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.chen.music.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.chen.music.ACTION.STOP_SERVICE";
    ...
    private void showNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, DebugActivity.class), 0);
